...
class DeepLabV3(SegmentationModel):
    ...
    def __init__(
        ...
        self.decoder = DeepLabV3Decoder(
            in_channels=self.encoder10.out_channels[-1] + self.encoder20.out_channels[-1] + self.encoder60.out_channels[-1],
