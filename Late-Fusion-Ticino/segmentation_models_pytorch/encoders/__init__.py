...
def get_encoder10(name, in_channels=4, depth=5, weights=None, output_stride=32, **kwargs):
...
def get_encoder20(name, in_channels=6, depth=5, weights=None, output_stride=32, **kwargs):
...
def get_encoder60(name, in_channels=1, depth=5, weights=None, output_stride=32, **kwargs):
